# Cadenas 1.7 | Jesús Alberto Domínguez Charris
...
while True:
    print("CADENAS 1.6 | Jesús Alberto Domínguez Charris")
    print("1. Consola\n2. Guardar en txt\n3. Leer txt\n4. Salir")
    menu = input(">>> ")
    ...
    if menu == "1":
        ...
        leer_cadena()
        # Guardar en un txt
        with open("cadenas-1.7.txt", "w", encoding="utf-8") as file:
        ...
        # Leer un txt
        with open("cadenas-1.7.txt", "r", encoding="utf-8") as file:
            contenido = file.read()
            print(contenido + "\n")

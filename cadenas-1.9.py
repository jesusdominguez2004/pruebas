# Cadenas 1.9 | Jesús Alberto Domínguez Charris
...
while True:
    # Menú
    print("CADENAS 1.9 | Jesús Alberto Domínguez Charris")
    print("1. Consola\n2. Guardar txt\n3. Leer txt\n4. Guardar json\n5. Leer json\n6. Salir")
    menu = input(">>> ")
    ...
    # Guardar txt
        ...
        leer_cadena()
        with open("cadenas-1.9.txt", "w", encoding="utf-8") as file:
    ...
    # Leer txt
        ...
        with open("cadenas-1.9.txt", "r", encoding="utf-8") as file:
            contenido = file.read()
            print(contenido)
    ...
    # Guardar json
        ...
        with open("json-1.9.txt", "w", encoding="utf-8") as file:
            json.dump(diccionario, file)
        print("¡Proceso de guardado json finalizado!\n")

    # Leer json
    elif menu == "5":
        with open("json-1.9.txt", "r", encoding="utf-8") as file:

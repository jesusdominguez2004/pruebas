# Cadenas 2.1 | Jesús Alberto Domínguez Charris
...
while True:
    # Menú
    print("CADENAS 2.1 | Jesús Alberto Domínguez Charris")
    print("1. Consola\n2. Guardar txt\n3. Leer txt")
    ...
    # Guardar txt
        ...
        leer_cadena()
        with open("cadenas-2.1.txt", "w", encoding="utf-8") as file:
    ...
    # Leer txt
        ...
        with open("cadenas-2.1.txt", "r", encoding="utf-8") as file:
            contenido = file.read()
            print(contenido)
    ...
    # Guardar json
        ...
        with open("json-2.1.txt", "w", encoding="utf-8") as file:
            json.dump(diccionario, file)
        print("¡Proceso de guardado json finalizado!\n")

    # Leer json
    elif menu == "5":
        with open("json-2.1.txt", "r", encoding="utf-8") as file:
            json_cadena = file.read()
            print(type(json_cadena), json_cadena)

            diccionario = json.loads(json_cadena)
            print(type(diccionario), diccionario)
    ...
    # Guardar morse
        ...
        for i in cadena.lower():
            cadena_morse += " " + morse.get(i)
        print(cadena_morse)
        with open("morse-2.1.txt", "w", encoding="utf-8") as file:
            file.write(cadena_morse)
        print("¡Proceso de guardado morse finalizado!\n")

    # Leer morse
    elif menu == "7":
        with open("morse-2.1.txt", "r", encoding="utf-8") as file:
            cadena_morse = file.read()
            lista_morse = cadena_morse.split()
            cadena = ""
            for i in lista_morse:
                cadena += morse_2.get(i)
            print(cadena_morse)
            print(cadena)

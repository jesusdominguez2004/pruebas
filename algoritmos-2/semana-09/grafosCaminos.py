...
class ListaAdyacencia:
    ...
    def caminosDosVertices(self, verticeInicial, verticeFinal):
        pass

    def verCaminosDosVertices(self, verticeInicial, verticeFinal):
        pass
    ...
    def __dfsModificado(self, inicio, arcosVisitados=None):
    ...
    def grafoConexo(self):
        ...
        for inicio in self.__listaVertices:
            visitadosInicio = self.__dfsModificado(inicio, arcosVisitados)
    ...
    """
    al menos un ciclo simple (Listo)
    contar ciclos simples
    ver ciclos simples
    
    al menos un ciclo no simple (en teoría no)
    contar ciclos no simples  (en teoría no)
    ver ciclos no simples  (en teoría no)

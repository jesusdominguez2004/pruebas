# Cadenas 2.0 | Jesús Alberto Domínguez Charris
...
while True:
    # Menú
    print("CADENAS 2.0 | Jesús Alberto Domínguez Charris")
    print("1. Consola\n2. Guardar txt\n3. Leer txt\n4. Guardar json\n5. Leer json\n6. Guardar morse\n7. Salir")
    menu = input(">>> ")
    ...
    # Guardar txt
        ...
        leer_cadena()
        with open("cadenas-2.0.txt", "w", encoding="utf-8") as file:
    ...
    # Leer txt
        ...
        with open("cadenas-2.0.txt", "r", encoding="utf-8") as file:
            contenido = file.read()
            print(contenido)
    ...
    # Guardar json
        ...
        with open("json-2.0.txt", "w", encoding="utf-8") as file:
            json.dump(diccionario, file)
        print("¡Proceso de guardado json finalizado!\n")

    # Leer json
    elif menu == "5":
        with open("json-2.0.txt", "r", encoding="utf-8") as file:
    ...
    # Guardar morse
        ...
        for caracter in cadena.lower():
            cadena_morse += " " + morse.get(caracter)
        print(cadena_morse)
        with open("morse-2.0.txt", "w", encoding="utf-8") as file:
